class InitializeGreetings < ActiveRecord::Migration[7.0]
  def up
    Vehicle.create(
      name: "Toyota Corolla",
      description: "Un confiable y eficiente vehículo compacto.",
      price: 20000.00,
    ...
    Vehicle.create(
      name: "Honda Civic",
      description: "Un vehículo compacto con un rendimiento deportivo.",
      price: 22000.00,
    ...
    Vehicle.create(
      name: "Ford F-150",
      description: "Una camioneta robusta y versátil.",
      price: 30000.00,
